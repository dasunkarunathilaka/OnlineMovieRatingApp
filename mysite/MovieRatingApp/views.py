...
def searchResults (request):
	...
	if tweetCount>15:
		...
		return render (request, 'movieratingapp/searchResults.html', {'movie_name':userInput, 'rating':ratedValue, 'firstText':sample_tweets[0][0], 'firstUser':sample_tweets[0][1], 'secondText':sample_tweets[1][0], 'secondUser':sample_tweets[1][1], 'videoURL':videoURL})
